...
public class AccountPersistence {
    private static final String FILE_PATH = "src/main/java/com/example/cuentasandisbank/data/Accounts.json";
    ...
    public void deleteAccount(Integer id) {
        ...
        accounts.removeIf(account -> account.getId() != null && account.getId().equals(id));;
        try {
            new ObjectMapper().writeValue(new File(FILE_PATH), accounts);
        } catch (IOException e) {
            e.printStackTrace();
